...
\begin{paracol}{2}
  ...
  \begin{rightcolumn}
    ...
    \par}
    \begin{itemize}
      \item Développe un frontend React en TypeScript pour créer et gérer les relâches de produits
      ...
      \item Exploite des outils d'IA ainsi que des workflows agentiques
