...
\begin{paracol}{2}
  \begin{leftcolumn}
    ...
    Java, Kotlin, Swift, Objective-C, PHP 8.5
    ...
    \subsection{AI}
    Opencode, Copilot, Claude Code, Agentic Coding
  ...
  \begin{rightcolumn}
    ...
    \par}
    \begin{itemize}
      \item Développe un frontend React en TypeScript pour créer et gérer les relâches, les artefacts et les produits
      ...
      \item Exploite des outils d'IA comme Copilot et Claude Code ainsi que des workflows agentiques
