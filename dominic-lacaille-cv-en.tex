...
\begin{paracol}{2}
  \begin{leftcolumn}
    ...
    \subsection{Resume}
    \href{https://github.com/dlacaille/resume}{\faNewspaperO\hspace{0.5em}github.com/dlacaille/resume}\\
    This very resume is written in LaTeX, and publicly available in GitHub
  ...
  \begin{rightcolumn}
    ...
    \subsection{Airline Technology Company, 01/2023 -- present}
